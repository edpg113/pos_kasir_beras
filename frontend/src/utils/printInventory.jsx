      ...
      <table className="inventory-table">
        ...
        <tbody>
          {inventory.map((item, i) => (
            <tr key={i}>
              ...
              <td className="text-right">
                {item.lastBiayaKuli != null
                  ? Number(item.lastBiayaKuli).toLocaleString("id-ID")
                  : "0"}
              </td>
              <td className="text-right">
                {item.lastBiayaSopir != null
                  ? Number(item.lastBiayaSopir).toLocaleString("id-ID")
                  : "0"}
              </td>
              <td className="text-right">
                {item.lastDP != null
                  ? Number(item.lastDP).toLocaleString("id-ID")
                  : "0"}
              </td>
              <td className="text-right">
                {item.lastTotal
        ...
        <tfoot>
          <tr style={{ background: "#f9f9f9", fontWeight: "bold" }}>
            ...
            <td style={{ textAlign: "right", padding: "10px" }} colSpan="4">
              {inventory
